...
function Home() {
    ...
    return (
        ...
        p1="Lo simplificamos en una frase, “el espacio es tuyo, el diseño interior es nuestro”. Por eso nos encanta ayudar a buscar la mejor solución que permita mejorar la calidad de vida de nuestros clientes a través de la creación de espacios armónicos y funcionales."
        p2="Idéalo ofrece un soporte personalizado y junto a ellos, comercializamos productos que nos lleven a concretar y hacer realidad una idea, A esto nos dedicamos y es lo que hacemos, ya que es nuestra pasión y razón de ser."
